...
public class TimeCountUtil extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        btn.setTextColor(CommonHelp.getColor(R.color.black));

        //设置按钮为灰色，这时是不能点击的
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.shape_bg_gray));
    ...
    public void onFinish() {
        btn.setText("重新获取验证码");
        btn.setTextColor(CommonHelp.getColor(R.color.colorPrimary));
        btn.setClickable(true);//重新获得点击
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.shape_bg_yellow));//还原背景色
    }
}
